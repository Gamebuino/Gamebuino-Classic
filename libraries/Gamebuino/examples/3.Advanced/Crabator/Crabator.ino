...
byte shake_timeLeft;
PROGMEM uint16_t player_damage_sound[] = {0x0045,0x564,0x0000};
...
PROGMEM uint16_t mob_death_sound[] = {0x0045,0x184,0x0000};
...
PROGMEM uint16_t magnum_sound[] = {0x0045,0x7049,0x17C,0x784D,0x42C,0x0000};
PROGMEM uint16_t p90_sound[] = {0x0045, 0x0154, 0x0000};
PROGMEM uint16_t p90_alternative_sound[] = {0x0045, 0x014C, 0x0000};
PROGMEM uint16_t ak47_sound[] = {0x0045, 0x012C, 0x0000};
PROGMEM uint16_t mg42_sound[] = {0x0045,0x140,0x8141,0x7849,0x788D,0x52C,0x0000};
PROGMEM uint16_t rpg_sound[] = {0x0045,0x8101,0x7F30,0x0000};

uint16_t* weapons_sounds[NUMWEAPONS] = {
  magnum_sound, p90_sound, ak47_sound, rpg_sound, mg42_sound};
PROGMEM uint16_t blast_sound[] = {0x0045,0x7849,0x784D,0xA28,0x0000};
int crate_x, crate_y;
PROGMEM uint16_t power_up[] = {0x0005,0x140,0x150,0x15C,0x170,0x180,0x16C,0x154,0x160,0x174,0x184,0x14C,0x15C,0x168,0x17C,0x18C,0x0000};
...
///////////////////////////////////// SETUP
void setup() {
  gb.begin(F("Crabator by Rodot"), bossSprite);
  gb.pickRandomSeed();
  loadHighscore();
}
